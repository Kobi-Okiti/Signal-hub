...
export default function CommunityOnboarding() {
  ...
  const createCommunity = async () => {
    ...
    if (!name) {
      showAlert("Validation", "Community name is required");
      return;
    }

    if (!description) {
      showAlert("Validation", "Community description is required");
      return;
    }

    if (!price) {
      showAlert("Validation", "Community price is required");
      return;
    }

    if (markets.length === 0) {
      showAlert("Validation", "Select at least one market");
      return;
    }
    ...
    try {
      ...
      if (communityError || !community) {
        ...
        showAlert("Error", "Failed to create community");
        return;
      }
      ...
      if (marketsError) {
        ...
        showAlert("Error", "Failed to save markets");
        return;
      }
